 ...
 * @author sohai
 */
public class editGradeFrame extends javax.swing.JFrame {

    /**
     * Creates new form addGradeFrame
     */
    public editGradeFrame() {
        initComponents();
    }
    ...
    private void addActionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addActionActionPerformed
        ...
        {
            String name = txtNameGrade.getText();
            String mark = txtMarkGrade.getText();
            String grade = txtGradeGrade.getText();
            DefaultTableModel tableModel=(DefaultTableModel)(StudentManager.getGradeTable()).getModel();
            tableModel.setValueAt(name, StudentManager.getGradeTable().getSelectedRow(), 0);
            tableModel.setValueAt(mark, StudentManager.getGradeTable().getSelectedRow(), 1);
            tableModel.setValueAt(grade, StudentManager.getGradeTable().getSelectedRow(), 2);
